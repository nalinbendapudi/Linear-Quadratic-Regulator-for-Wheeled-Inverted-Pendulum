...
#define MDIR1_PIN               1,28 //MDIRR1 gpio(CHIP.PIN) P9.12
//#define MDIR2_CHIP              1 // chip of MDIR2 gpio pin
#define MDIR2_PIN               1,16 //  MDIRR2 gpio(CHIP.PIN) P9.15
...
#define WHEEL_DIAMETER            0.08392   //wheel diameter
#define WHEEL_BASE                0.22274   // wheel separation distance in meters
